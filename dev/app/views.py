...
def schools_json():
    with db:
        cur = db.cursor()
        cur.execute("SELECT SCHOOL_NAME, 2012_2013, 2011_2012, 2010_11, 2009_10, 2008_09, 2007_08, 2006_07 FROM Multiyear")
        query_results = cur.fetchall()
    schools = []
    for result in query_results:
        schools.append(dict(school=result[0], grade2013=result[1], grade2012=result[2], grade2011=result[3], grade2010=result[4], \
