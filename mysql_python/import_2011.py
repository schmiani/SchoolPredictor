...
cur.execute('DROP TABLE IF EXISTS All_2011')

input_file = '../data/2010_2011_All_ProgressReportResults_2013_10_25.csv'
...
query = 'CREATE TABLE All_2011(' + ",".join(querylist) + ')'
cur.execute(query)

query = 'INSERT INTO All_2011(' + '%s, ' *(len(headersql)-1) + '%s)'
