...
cur.execute('DROP TABLE IF EXISTS All_2012')

input_file = '../data/2011_2012_All_ProgressReport_Results_2013_4_11.csv'
...
query = 'CREATE TABLE All_2012(' + ",".join(querylist) + ')'
cur.execute(query)

query = 'INSERT INTO All_2012(' + '%s, ' *(len(headersql)-1) + '%s)'
